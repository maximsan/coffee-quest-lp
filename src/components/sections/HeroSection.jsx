...
export function HeroSection() {
  return (
    ...
    >
      <div className="rise-in mx-auto flex max-w-190 flex-col items-center gap-5 text-center lg:mx-0 lg:max-w-none lg:items-start lg:text-left">
      ...
      <div className="rise-in delay-2 relative mx-auto flex w-full max-w-230 justify-center lg:max-w-130">
